...
namespace Abituria
{
    ...
    public partial class Calculator : Window
    {
        ...
        private bool SprawdzCzyE(string operation)
            => operation.Contains('E') && (Regex.Matches(operation, "[+]").Count == 1 || Regex.Matches(operation, "[-]").Count == 1);//bez dwóch znaków
