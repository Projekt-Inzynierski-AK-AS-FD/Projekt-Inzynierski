...
namespace Abituria
{
    ...
    {
        private static T mConverter = null;///Pojedyńcza statyczna instancja tego konwertera wartości
        public override object ProvideValue(IServiceProvider serviceProvider)///Rozszerzenie metody znacznika
        {
            return mConverter ?? (mConverter = new T());///Jeżeli prywatny członek konwertera ma wartość null, to tworzymy instancje typu generycznego
        }
