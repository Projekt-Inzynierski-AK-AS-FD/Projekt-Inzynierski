...
namespace Abituria
{
    public abstract class BaseValueConverter<T> : MarkupExtension, IValueConverter where T : class, new()///Bazowy konwerter wartości pozwala na bezpośrednie użycie XAML
    {
        ...
        public override object ProvideValue(IServiceProvider serviceProvider) => Converter ?? (Converter = new T());///Jeżeli prywatny członek konwertera ma wartość null, to tworzymy instancje typu generycznego
